...
The initializer creates no remote repository, remote, commit, or push. Establishing the initial shared target—and any first Git source publication—still requires deliberate setup:
